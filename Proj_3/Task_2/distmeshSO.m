function [ p, t, b, L, stat ] = distmesh_SO( fd, fh, h0, bbox, p_fix, e_fix, it_max, fid, fit )
...
if( size(p,2)==2 )
  global counter
  counter=counter+1;
  hf=patch( 'vertices', p, 'faces', t, 'facecolor', COLOR )
  pathFig='/Users/tinos/Documents/EDAC/Teaching/Lectures/SO/2025/Project_3/distmesh-master/Project_3';
  saveas(hf,[pathFig num2str(counter) '.png']);
